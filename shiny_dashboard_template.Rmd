...
sliderInput(
  "rank_range", 
  label = h3("Choose rank range"), 
  min = min_rank, max = max_rank, value = c(167))
...
In our dataset, for those that made it into the world cup, the  `r renderPrint({input[["country_choice"]]})`
