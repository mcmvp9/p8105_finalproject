...
<br>
# To check for colinearity, we use correlation plot to explore the relationship between each pair of numereic predictors.
...
From the violin plot, we can see that model 3 has the lowest rmse.
